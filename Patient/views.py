...
def send_email_celery(date, dock, patient, email):
    ...
    message = 'You have a new appointment request on' + {date} + 'please kindly make a response to ' + {patient} + ' click here to goto confirm page -> http://localhost:3000/appointment_list thank you'
