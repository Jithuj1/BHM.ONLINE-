...
# @api_view(['GET'])
# def doctor_search(request, key):
#     k = Patient.objects.filter(status = True)
#     print(k)
#     dock = Doctors.objects.filter(doctor_id.first_name__icontains=key)
#     if dock:
#         serializer = DoctorSerializer(dock, many = True)
#         return Response (serializer.data)
#     else:
